...
export const listOrders = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(`https://backmudilix-100000.onrender.com/api/orders/all`, config);
...
export const getOrderDetails = (id) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(`https://backmudilix-100000.onrender.com/api/orders/${id}`, config);
